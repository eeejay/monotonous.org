...
<figure id="attachment_875" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-875" src="../rate_osx_alex.png" alt="Rate distribution of Alex voice on OSX" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Rate distribution of Alex voice on OSX</figcaption></figure>  
...
<figure id="attachment_885" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-885" src="../rate_osx_carmit.png" alt="Carmit rate distribution" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Carmit rate distribution</figcaption></figure>  
...
<figure id="attachment_893" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-893" src="../rate_osx_bad_news.png" alt="Bad News rate distribution" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Bad News rate distribution</figcaption></figure>  
...
<figure id="attachment_921" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-921" src="../rate_windows_broken.png" alt="Broken rate distribution on Windows" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Broken rate distribution on Windows</figcaption></figure>  
...
<img class="alignnone size-full wp-image-934" src="../rate_windows_fixed.png" alt="Fixed Windows rate distribution" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /> <figcaption class="wp-caption-text">Fixed Windows rate distribution</figcaption></figure> 
...
<img class="alignnone size-full wp-image-955" src="../rate_linux_fixed.png" alt="Fixed rate distribution on Linux" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /> <figcaption class="wp-caption-text">Fixed rate distribution on Linux</figcaption></figure> 
...
<figure id="attachment_965" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-965" src="../rate_all_broken.png" alt="Rate distribution on all three platforms before fix" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Rate distribution on all three platforms before fix</figcaption></figure>  
And look how clean and nice it is now:  
<figure id="attachment_968" style="width: 1527px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-968" src="../rate_all_fixed.png" alt="Fixed rate distribution on all three platforms" width="1527" height="816" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Fixed rate distribution on all three platforms</figcaption></figure>  
&nbsp;  
&nbsp;  
&nbsp;