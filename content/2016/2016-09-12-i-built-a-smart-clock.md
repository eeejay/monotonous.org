...
<figure id="attachment_1155" style="width: 300px" class="wp-caption aligncenter"><img class="wp-image-1155 size-medium" src="../p1070936jpg_29262204520_o.jpg?w=300" alt="Final clock. Translucent body showing all components including gears and Raspberry Pi." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">The future of time telling.</figcaption></figure>  
...
<div style="clear:both;">
  <figure id="attachment_1156" style="width: 300px" class="wp-caption alignleft"><img class="size-medium wp-image-1156" src="../p1060972.jpg?w=300" alt="An example of an early super elaborate and huge gearbox." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">An example of an early super elaborate and huge gear box.</figcaption></figure><br /> <figure id="attachment_1157" style="width: 300px" class="wp-caption alignright"><img class="size-medium wp-image-1157" src="../p1070903jpg_29379879016_o.jpg?w=300" alt="My final design." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">My final design.</figcaption></figure>
</div>
...
<figure id="attachment_1158" style="width: 300px" class="wp-caption aligncenter"><img class="size-medium wp-image-1158" src="../p1070908jpg_29334676491_o.jpg?w=300" alt="Two magnets on opposite sides of the gear, and the hall effect sensor is clamped just above the gear to detect them." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">Two magnets on opposite sides of the gear, and the hall effect sensor clamped just above the gear to detect polarity changes.</figcaption></figure>
...
<img class="aligncenter size-medium wp-image-1160" src="../img_20160701_212504_28030141675_o.jpg?w=300" alt="Breadboard, raspberry pi, motor drivers and gearbox all taped to a peice of cardboard." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" />  
...
<img class="aligncenter size-medium wp-image-1161" src="../img_20160708_234832_27572238683_o.jpg?w=225" alt="BOttom of perfboard showing a lot of bare wires and soldering." width="225" height="300" sizes="(max-width: 225px) 100vw, 225px" />  
...
<img class="aligncenter wp-image-1162 size-medium" src="../screenshot-from-2016-09-09-13-03-34.png?w=300" alt="Screenshot of Fritzing design app." width="300" height="169" sizes="(max-width: 300px) 100vw, 300px" />  
&#8230;and ordered PCB prints from their online service. After a month or so I got these in the mail:  
<figure id="attachment_1163" style="width: 300px" class="wp-caption aligncenter"><img class="size-medium wp-image-1163" src="../p1070880jpg_28792531333_o.jpg?w=300" alt="Custom PCBs printed in Berlin!" width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">Custom PCBs printed in Berlin!</figcaption></figure>  
Soldering on components was a breeze&#8230;  
<figure id="attachment_1164" style="width: 300px" class="wp-caption aligncenter"><img class="size-medium wp-image-1164" src="../p1070887jpg_29305709512_o.jpg?w=300" alt="PCB with jumper headers and resistors." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">PCB with jumper headers and resistors.</figcaption></figure>
...
<img class="aligncenter size-medium wp-image-1165" src="../screenshot_2016-09-09-12-45-38.png?w=169" alt="The web interface, with a form to set the time on the clock." width="169" height="300" sizes="(max-width: 169px) 100vw, 169px" />  
...
<figure id="attachment_1169" style="width: 300px" class="wp-caption aligncenter"><img class="size-medium wp-image-1169" src="../p1070911jpg_29379977416_o.jpg?w=300" alt="Call the components mounted on the acrylic disc." width="300" height="225" sizes="(max-width: 300px) 100vw, 300px" /><figcaption class="wp-caption-text">All the components mounted on the acrylic disc.</figcaption></figure>
