...
<figure id="attachment_987" style="width: 4592px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-987" src="../p1070571.jpg" alt="A pathetic house plant" width="4592" height="3448" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Our sad sad plant.</figcaption></figure>  
...
<figure id="attachment_1027" style="width: 4078px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-1027" src="../p10705881.jpg" alt="Brilliant schematic" width="4078" height="3105" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" /><figcaption class="wp-caption-text">Air is pumped into a sealed jar with an outlet tube that relieves the jar&#8217;s pressure by pushing water out through another tube!</figcaption></figure>  
...
<img class="alignnone size-full wp-image-1087" src="../p1070577.jpg?w=9184" alt="Jar lid with two tubes running through" width="4592" height="3448" />  
...
<img class="alignnone size-full wp-image-1090" src="../p1070568.jpg" alt="Aquarium air pump with 4 outlets" width="4592" height="3448" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" />  
...
<figure id="attachment_1098" style="width: 4592px" class="wp-caption alignnone"><img class="alignnone size-full wp-image-1098" src="../p1070590.jpg?w=9184" alt="Bayit WiFi Socket" width="4592" height="3448" /><figcaption class="wp-caption-text">The Internet is in control!</figcaption></figure>  
