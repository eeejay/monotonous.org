...
<img class="alignnone size-full wp-image-1141" src="../screen-shot-2016-05-28-at-00-01-06.png" alt="Screen shot of button in off state" width="2048" height="1536" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" />  
And when you turn it on it looks like this:  
<img class="alignnone size-full wp-image-1143" src="../screen-shot-2016-05-28-at-00-01-12.png" alt="Screen shot of button in on state" width="2048" height="1536" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px" />  
