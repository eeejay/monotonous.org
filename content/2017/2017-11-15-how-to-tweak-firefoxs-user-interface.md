...
<figure id="attachment_1338" style="width: 660px" class="wp-caption aligncenter"><img class="size-large wp-image-1338" src="../screenshot-from-2017-11-15-16-01-53.png?w=660" alt="" width="660" height="469" sizes="(max-width: 660px) 100vw, 660px" /><figcaption class="wp-caption-text">Restylized user interface with yellow on black text</figcaption></figure>  
