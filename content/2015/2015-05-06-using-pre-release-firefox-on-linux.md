...
<figure id="attachment_674" style="width: 660px" class="wp-caption aligncenter">[<img class="size-large wp-image-674" src="../screenshot-from-2015-05-06-12-08-51.png?w=660" alt="Nightly running in Fedora 22" width="660" height="371" sizes="(max-width: 660px) 100vw, 660px" />](/assets/uploads/2015/05/screenshot-from-2015-05-06-12-08-51.png)<figcaption class="wp-caption-text">See the nice icon?</figcaption></figure>  
