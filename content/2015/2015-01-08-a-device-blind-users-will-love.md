...
<img class="aligncenter wp-image-630 size-medium" src="../mozilla-accessibility_logo-only_rgb.png?w=300" alt="Mozilla accessibility logo" width="300" height="300" sizes="(max-width: 300px) 100vw, 300px" />  
...
<figure id="attachment_634" style="width: 460px" class="wp-caption aligncenter"><img class="wp-image-634 size-large" src="../benicia_grass_fire_1-1024x684.jpg?w=460" alt="helicopter dumps water on a grass fire" width="460" height="307" sizes="(max-width: 460px) 100vw, 460px" /><figcaption class="wp-caption-text">A California Department of Forestry helicopter dumps water on a grass fire in Benicia. (Robinson Kuntz/Daily Republic)</figcaption></figure>  
...
<img class="aligncenter wp-image-636 size-large" src="../thegap.jpg?w=460" alt="The gap between Firefox OS and the screen reader" width="460" height="563" sizes="(max-width: 460px) 100vw, 460px" />  
...
<figure id="attachment_655" style="width: 460px" class="wp-caption aligncenter"><img class="wp-image-655 size-large" src="../texting-while-driving.jpg?w=460" alt="A driver texting in traffic" width="460" height="325" sizes="(max-width: 460px) 100vw, 460px" /><figcaption class="wp-caption-text">This shouldn&#8217;t happen.</figcaption></figure>  
...
<figure id="attachment_659" style="width: 460px" class="wp-caption aligncenter"><img class="wp-image-659 size-large" src="../impact_graph.jpg?w=460" alt="Graph showing impact on blind users in contrast to other users" width="460" height="589" sizes="(max-width: 460px) 100vw, 460px" /><figcaption class="wp-caption-text">While blind smart phone users are a small fraction of the general population, the impact on their lives is so much greater.</figcaption></figure>  
...
[<img class="aligncenter size-large wp-image-658" src="../5953945.jpg?w=460" alt="Three blind iphone owners" width="460" height="268" sizes="(max-width: 460px) 100vw, 460px" />](http://www.stuff.co.nz/technology/gadgets/5953951/iPhone-4S-Life-changing-phone-for-blind)
